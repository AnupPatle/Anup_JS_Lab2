 ...
 * 4. Which is used to connect to Databse --> PHP, HTML, JS, All --> PHP
...
let questions = [
    ...
    new Question("Which is used to connect to Databse", ["PHP", "HTML", "JS", "All"], "PHP"),
...
function showScore(){
    let result = `"<h1>Result</h1><h2 id="score">Your scores: ${quiz.score}.And mark percentage is: ${(quiz.score/questions.length)*100}%"`
